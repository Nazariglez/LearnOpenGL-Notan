...
const MATERIAL_FRAGMENT_SHADER: ShaderSource = notan::fragment_shader! {
  r#"
    ...
    void main()
    {
        ...
        vec3 specular = light.specular * spec * (vec3(1.0) - vec3(texture(specular_texture, TexCoords))); // here we inverse the sampled specular color. Black becomes white and white becomes black.
