  ...
  r#"
    ...
    void main()
    {
        ...
        vec3 specular = light.specular * spec * texture(specular_texture, TexCoords).rgb;
          ...
          // emission
        vec3 emission = texture(emission_texture, TexCoords).rgb;
...
fn setup(app: &mut App, gfx: &mut Graphics) -> State {
    ...
    let material_pipeline = gfx
        ...
        .with_texture_location(2, "emission_texture")
        .build()
        .unwrap();
    ...
    let emission_texture = gfx
        .create_texture()
        .from_image(include_bytes!("../../resources/textures/matrix.jpg"))
        .build()
        .unwrap();
...
fn draw(gfx: &mut Graphics, state: &mut State) {
    ...
    renderer.bind_texture_slot(2, 2, &state.emission_texture);
    renderer.draw(0, 36);
